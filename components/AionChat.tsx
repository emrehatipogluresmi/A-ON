        ...
        <div className="flex flex-col h-full p-6">
          <div className="flex items-center justify-between mb-8">
            <button 
              ...
              className="flex items-center justify-center gap-2 flex-1 py-3 rounded-xl border border-white/10 hover:bg-white/5 transition-all text-sm text-white/80"
            >
            ...
            <button 
              onClick={() => setIsSidebarOpen(false)}
              className="lg:hidden ml-2 p-3 text-white/40 hover:text-white"
            >
      ...
      <div className="flex-1 flex flex-col relative pt-24 min-w-0">
        ...
        {!isSidebarOpen && (
          <button 
            ...
            className="lg:hidden absolute top-28 left-6 z-40 p-3 glass rounded-xl text-white/60 hover:text-white transition-all shadow-xl"
          >
